...
class _WebSocketLed extends State<WebSocketLed>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title:Text("Devices", style: kreusablecardtextstyle.copyWith(fontSize: 20, color: Colors.black),),
      ...
      body:Container(
          ...
          child:Column(
            children:[
              Container(
                  child: connected?Text("WEBSOCKET: CONNECTED"):Text("No devices detected")
              ),
              ...
              Container(
                  ...
                  child: MaterialButton( //button to start scanning
